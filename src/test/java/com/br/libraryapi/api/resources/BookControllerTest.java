...
public class BookControllerTest {
	...
	public void deleteBook() throws Exception {
		...
		BDDMockito.given(service.getById(Mockito.anyLong())).willReturn(
				Optional.of(Book.builder().id(Long.valueOf("1")).build()));
	...
	@Test
	@DisplayName("Deve retornar resource not found quando nao encontrar o livro a deletar")
	public void deleteInexistsBook() throws Exception {
